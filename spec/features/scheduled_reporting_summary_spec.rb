...
RSpec.feature 'Scheduled reporting summary' do
  ...
  def given_several_booking_locations_exist # rubocop:disable MethodLength
  ...
  def then_the_correct_daily_statistics_are_persisted # rubocop:disable AbcSize, MethodLength
